...
enum ButtonType {
    case cover, row , char, space, backspace, confirm, cursor, settingToggle, enterSettings, customPhrase, enterPhrases, addNewPhrase, tutorial, settingTutorial, exit, enterCalibration, calibration, calibrationConf, calibHelp, calibConfHelp, clear
}
